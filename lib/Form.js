...
* @return {Array}
*/
Form.prototype._getEditableFields = function () {
...
Form.prototype.serialize = function () {
  return reduce(this._getEditableFields(), function (carry, field) {
...
Form.prototype.isValid = function () {
  ...
  return every(this._getEditableFields(), function (field) {
...
Form.prototype.getInvalidFields = function () {
  return filter(this._getEditableFields(), function (field) {
    return !field.isValid();
  });
};
